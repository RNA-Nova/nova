...
import type { NovaUIRuntime, TranscriptEntry } from 'nova-client';
import { entrySlot, type EntryRenderer, type NovaBlock } from 'nova-client';
...
export class TranscriptController {
  ...
  private createEntry(entry: TranscriptEntry): Component {
    switch (entry.kind) {
      ...
      case 'toolCall':
        return new ToolCardView(this.runtime, entry.item, this.expansion, () =>
          this.tui.requestRender(),
        );
      case 'notice': {
