...
from nova_exec_server_client.pool import CHANNEL_CONTROL, CHANNEL_DATA
from nova_exec_server_client.transport import Transport
...
def test_from_stdio_builds_stdio_transports():
    ...
    assert client.transport.program == "nova-exec-server"
