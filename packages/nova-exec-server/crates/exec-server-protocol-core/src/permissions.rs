...
use nova_exec_server_utils_absolute_path::canonicalize_preserving_symlinks;
...
pub(crate) fn default_read_only_subpaths_for_writable_root(
    ...
    let top_level_nova = writable_root.join(PROTECTED_METADATA_NOVA_EXEC_SERVER_PATH_NAME);
...
mod tests {
    ...
    #[cfg(unix)]
    const SYMLINKED_TMPDIR_TEST_ENV: &str = "NOVA_EXEC_SERVER_PROTOCOL_TEST_SYMLINKED_TMPDIR";
