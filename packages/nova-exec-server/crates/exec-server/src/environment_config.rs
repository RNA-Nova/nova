...
use nova_exec_server_protocol::EnvironmentConfigLayer;
use nova_exec_server_protocol::EnvironmentConfigLayerFormat;
use nova_exec_server_protocol::EnvironmentConfigLayerStack;
use nova_exec_server_protocol::EnvironmentConfigReadParams;
use nova_exec_server_protocol::EnvironmentConfigReadResponse;
use nova_exec_server_utils_absolute_path::AbsolutePathBuf;
use nova_exec_server_utils_home_dir::find_nova_exec_server_home;
...
pub(crate) async fn read_environment_config(
    ...
    let executor_home = find_nova_exec_server_home().map_err(|error| {
