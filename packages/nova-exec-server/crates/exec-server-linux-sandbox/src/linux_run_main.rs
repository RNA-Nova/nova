...
use nova_exec_server_protocol_core::error::Result as NovaResult;
use nova_exec_server_protocol_core::models::PermissionProfile;
use nova_exec_server_protocol_core::protocol::FileSystemAccessMode;
use nova_exec_server_protocol_core::protocol::FileSystemPath;
use nova_exec_server_protocol_core::protocol::FileSystemSandboxEntry;
...
use nova_exec_server_sandboxing::landlock::NOVA_EXEC_SERVER_LINUX_SANDBOX_ARG0;
...
fn exit_with_bwrap_build_error(err: nova_exec_server_protocol_core::error::ExecErr) -> ! {
...
fn apply_inner_command_argv0_for_launcher(
    ...
    if supports_argv0 {
        argv.splice(
            ...
            ["--argv0".to_string(), NOVA_EXEC_SERVER_LINUX_SANDBOX_ARG0.to_string()],
        );
        return;
    }
