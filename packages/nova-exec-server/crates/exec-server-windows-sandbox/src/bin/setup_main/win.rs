...
use nova_exec_server_windows_sandbox::SETUP_VERSION;
use nova_exec_server_windows_sandbox::SetupErrorCode;
use nova_exec_server_windows_sandbox::SetupErrorReport;
use nova_exec_server_windows_sandbox::SetupFailure;
use nova_exec_server_windows_sandbox::add_deny_write_ace;
use nova_exec_server_windows_sandbox::convert_string_sid_to_sid;
use nova_exec_server_windows_sandbox::ensure_allow_mask_aces_with_inheritance;
use nova_exec_server_windows_sandbox::ensure_allow_write_aces;
use nova_exec_server_windows_sandbox::extract_setup_failure;
use nova_exec_server_windows_sandbox::hide_newly_created_users;
use nova_exec_server_windows_sandbox::install_wfp_filters;
use nova_exec_server_windows_sandbox::log_note;
use nova_exec_server_windows_sandbox::log_writer;
use nova_exec_server_windows_sandbox::path_mask_allows;
use nova_exec_server_windows_sandbox::path_write_aces_need_refresh;
use nova_exec_server_windows_sandbox::sandbox_bin_dir;
use nova_exec_server_windows_sandbox::sandbox_dir;
use nova_exec_server_windows_sandbox::sandbox_secrets_dir;
use nova_exec_server_windows_sandbox::string_from_sid_bytes;
use nova_exec_server_windows_sandbox::sync_persistent_deny_read_acls;
use nova_exec_server_windows_sandbox::to_wide;
use nova_exec_server_windows_sandbox::workspace_write_cap_sid_for_root;
use nova_exec_server_windows_sandbox::workspace_write_root_overlaps_path;
use nova_exec_server_windows_sandbox::write_setup_error_report;
...
fn lock_sandbox_dir(
    ...
    // ProvisionOnly accepts another user's NOVA_EXEC_SERVER_HOME; keep its ACL mutation
...
pub fn main() -> Result<()> {
    ...
    if let Err(e) = &ret {
        ...
        if let Ok(sandbox_home) = std::env::var("NOVA_EXEC_SERVER_HOME") {
...
mod tests {
    ...
    use nova_exec_server_windows_sandbox::ensure_allow_mask_aces;
    use nova_exec_server_windows_sandbox::ensure_allow_write_aces;
    use nova_exec_server_windows_sandbox::load_or_create_cap_sids;
    use nova_exec_server_windows_sandbox::path_mask_allows;
    use nova_exec_server_windows_sandbox::path_write_aces_need_refresh;
    use nova_exec_server_windows_sandbox::workspace_write_cap_sid_for_root;
    ...
    fn payload_json() -> serde_json::Value {
        json!({
            ...
            "offline_username": "NovaSandboxOffline",
            "online_username": "NovaSandboxOnline",
            "sandbox_home": "C:\\sandbox-home",
