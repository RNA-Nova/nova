...
use anyhow::Context;
use anyhow::Result;
use nova_exec_server_utils_pty::JobObject;
use nova_exec_server_windows_sandbox::ConsoleMode;
use nova_exec_server_windows_sandbox::ErrorPayload;
use nova_exec_server_windows_sandbox::ErrorStage;
use nova_exec_server_windows_sandbox::ExitPayload;
use nova_exec_server_windows_sandbox::FramedMessage;
use nova_exec_server_windows_sandbox::IPC_PROTOCOL_VERSION;
use nova_exec_server_windows_sandbox::LaunchDesktop;
use nova_exec_server_windows_sandbox::LocalSid;
use nova_exec_server_windows_sandbox::Message;
use nova_exec_server_windows_sandbox::OutputPayload;
use nova_exec_server_windows_sandbox::OutputStream;
use nova_exec_server_windows_sandbox::PipeSpawnHandles;
use nova_exec_server_windows_sandbox::ResizePayload;
use nova_exec_server_windows_sandbox::SpawnReady;
use nova_exec_server_windows_sandbox::SpawnRequest;
use nova_exec_server_windows_sandbox::StderrMode;
use nova_exec_server_windows_sandbox::StdinMode;
use nova_exec_server_windows_sandbox::WindowsSandboxTokenMode;
use nova_exec_server_windows_sandbox::allow_null_device;
use nova_exec_server_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use nova_exec_server_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use nova_exec_server_windows_sandbox::decode_bytes;
use nova_exec_server_windows_sandbox::encode_bytes;
use nova_exec_server_windows_sandbox::get_current_token_for_restriction;
use nova_exec_server_windows_sandbox::hide_current_user_profile_dir;
use nova_exec_server_windows_sandbox::log_note;
use nova_exec_server_windows_sandbox::read_frame;
use nova_exec_server_windows_sandbox::read_handle_loop;
use nova_exec_server_windows_sandbox::spawn_process_with_pipes;
use nova_exec_server_windows_sandbox::to_wide;
use nova_exec_server_windows_sandbox::token_mode_for_permission_profile;
use nova_exec_server_windows_sandbox::write_frame;
use std::ffi::OsStr;
use std::fs::File;
...
// Kept in sync with nova_exec_server::NOVA_EXEC_SERVER_FS_HELPER_ARG1 without introducing
// a dependency cycle.
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<nova_exec_server_windows_sandbox::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    ...
    let (pi, job, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = nova_exec_server_windows_sandbox::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
