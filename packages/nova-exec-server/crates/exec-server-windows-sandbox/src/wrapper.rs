//! Internal `nova-exec-server --run-as-windows-sandbox` wrapper.
//!
...
pub const NOVA_EXEC_SERVER_WINDOWS_SANDBOX_ARG1: &str = "--run-as-windows-sandbox";
...
pub fn create_windows_sandbox_command_args_for_permission_profile(
    ...
    let mut args = vec![
        NOVA_EXEC_SERVER_WINDOWS_SANDBOX_ARG1.to_string(),
