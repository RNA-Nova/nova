...
/// Basename used when the nova-exec-server executable self-invokes as the Linux sandbox
/// helper.
pub const NOVA_EXEC_SERVER_LINUX_SANDBOX_ARG0: &str = "nova-linux-sandbox";
