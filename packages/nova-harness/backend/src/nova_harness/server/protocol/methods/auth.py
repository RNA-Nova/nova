...
def register(registry: MethodRegistry, state: ServerState) -> None:
    ...
    def _provider(params: Any) -> str:
        return params.provider

    async def getAuthStatus(params: shapes.EmptyParams) -> GetAuthStatusResult:
    ...
    async def setApiKey(params: shapes.SetApiKeyParams) -> ProviderResult:
        ...
        return ProviderResult(success=True, provider=provider)

    async def login(params: shapes.LoginParams) -> LoginResult:
        ...
        return LoginResult(success=True, provider=provider, type=cred_type)

    async def logout(params: shapes.ProviderParams) -> ProviderResult:
