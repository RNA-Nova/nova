...
**说明**：真实模型，未注册任何工具
  ...
  6. message_update | role=assistant | content=['text'] × 38
...
**说明**：真实模型 + EchoTool
  ...
  8. tool_execution_start | tool=echo | id=call_k5r
  9. tool_execution_update | tool=echo | id=call_k5r
 10. tool_execution_end | tool=echo | id=call_k5r | is_error=False
...
**说明**：真实模型 + ErrorTool
  ...
  7. message_end | role=assistant | content=['toolCall']
  8. tool_execution_start | tool=error_tool | id=call_ov3
  9. tool_execution_end | tool=error_tool | id=call_ov3 | is_error=True
 ...
 15. message_update | role=assistant | content=['text'] × 21
...
**说明**：真实模型 + EchoTool + before block
  ...
  6. message_update | role=assistant | content=['toolCall'] × 7
  7. message_end | role=assistant | content=['toolCall']
  8. tool_execution_start | tool=echo | id=call_4j6
  9. tool_execution_end | tool=echo | id=call_4j6 | is_error=True
 10. message_start | role=toolResult | text='blocked by test'
 11. message_end | role=toolResult | text='blocked by test'
 12. turn_end | role=assistant | content=['toolCall']
 13. turn_start
 14. message_start | role=assistant | content=[]
 15. message_update | role=assistant | content=['text'] × 51
 16. message_end | role=assistant | content=['text']
 17. turn_end | role=assistant | content=['text']
 18. agent_end
...
**说明**：真实模型 + EchoTool + after override
  ...
  6. message_update | role=assistant | content=['toolCall'] × 7
  7. message_end | role=assistant | content=['toolCall']
  8. tool_execution_start | tool=echo | id=call_p70
  9. tool_execution_update | tool=echo | id=call_p70
 10. tool_execution_end | tool=echo | id=call_p70 | is_error=False
 11. message_start | role=toolResult | text='overridden'
 12. message_end | role=toolResult | text='overridden'
 13. turn_end | role=assistant | content=['toolCall']
 14. turn_start
 15. message_start | role=assistant | content=[]
 16. message_update | role=assistant | content=['text'] × 26
 17. message_end | role=assistant | content=['text']
 18. turn_end | role=assistant | content=['text']
 19. agent_end
...
**说明**：真实模型 + SlowTool
  ...
  6. message_update | role=assistant | content=['toolCall'] × 4
  7. message_end | role=assistant | content=['toolCall']
  8. tool_execution_start | tool=slow_tool | id=call_q11
  9. tool_execution_end | tool=slow_tool | id=call_q11 | is_error=True
...
**说明**：真实模型 + GetDateTool + GetTimeTool
  ...
  8. tool_execution_start | tool=get_date | id=call_i59
  9. tool_execution_start | tool=get_time | id=call_0o1
 10. tool_execution_end | tool=get_date | id=call_i59 | is_error=False
 11. tool_execution_end | tool=get_time | id=call_0o1 | is_error=False
 ...
 19. message_update | role=assistant | content=['text'] × 23
...
**说明**：真实模型
  ...
  5. message_start | role=assistant | content=[]
  6. message_update | role=assistant | content=['text'] × 25
  7. message_end | role=assistant | content=['text']
  8. turn_end | role=assistant | content=['text']
  9. turn_start
...
**说明**：真实模型
  ...
  5. message_start | role=assistant | content=[]
  6. message_update | role=assistant | content=['text'] × 14
  7. message_end | role=assistant | content=['text']
  8. turn_end | role=assistant | content=['text']
  9. turn_start
 ...
 12. message_start | role=assistant | content=[]
 13. message_update | role=assistant | content=['text'] × 22
 14. message_end | role=assistant | content=['text']
 15. turn_end | role=assistant | content=['text']
 16. agent_end
...
**运行异常**：RuntimeError: No model configured. Call set_model() or provide initial_state with a model before prompt().
...
### J. 准备阶段 abort（mock）
**说明**：before hook 等待 signal，外部任务触发 abort，之后返回文本回复
