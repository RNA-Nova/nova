...
from nova_ai.types import (
    KnownApi, KnownProvider, StopReason,
    ThinkingLevel, CacheRetention, Transport, ThinkingFormat,
    TextContent, ThinkingContent, ImageContent, ToolCall,
    Usage, Cost,
    Model, ModelCost,
    UserMessage, AssistantMessage, ToolResultMessage, Tool, Context,
    StreamOptions, SimpleStreamOptions,
    StartEvent, TextDeltaEvent, TextEndEvent,
    ThinkingEndEvent,
    ToolCallEndEvent,
...
class TestEvents:
    ...
    def test_text_end_event_content_is_str(self):
        ...
        e = TextEndEvent(content="hello world")
