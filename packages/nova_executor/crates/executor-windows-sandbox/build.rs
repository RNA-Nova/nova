...
const SETUP_BIN: &str = "nova-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "nova-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so executables that link the
