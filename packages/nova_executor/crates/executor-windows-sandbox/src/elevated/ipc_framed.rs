        ...
        let msg = FramedMessage {
            ...
            message: Message::SpawnRequest {
                payload: Box::new(SpawnRequest {
                    ...
                    sandbox_home: PathBuf::from(r"C:\sandbox"),
                    real_sandbox_home: PathBuf::from(r"C:\Users\sandbox"),
                    ...
                    private_desktop_name: Some("NovaSandboxDesktop-1234".to_string()),
                }),
            },
        };
