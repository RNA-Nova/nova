...
use anyhow::Context;
use anyhow::Result;
use nova_executor_utils_pty::JobObject;
use nova_executor_windows_sandbox::ConsoleMode;
use nova_executor_windows_sandbox::ErrorPayload;
use nova_executor_windows_sandbox::ErrorStage;
use nova_executor_windows_sandbox::ExitPayload;
use nova_executor_windows_sandbox::FramedMessage;
use nova_executor_windows_sandbox::IPC_PROTOCOL_VERSION;
use nova_executor_windows_sandbox::LocalSid;
use nova_executor_windows_sandbox::Message;
use nova_executor_windows_sandbox::OutputPayload;
use nova_executor_windows_sandbox::OutputStream;
use nova_executor_windows_sandbox::PipeSpawnHandles;
use nova_executor_windows_sandbox::ResizePayload;
use nova_executor_windows_sandbox::SpawnReady;
use nova_executor_windows_sandbox::SpawnRequest;
use nova_executor_windows_sandbox::StderrMode;
use nova_executor_windows_sandbox::StdinMode;
use nova_executor_windows_sandbox::WindowsSandboxTokenMode;
use nova_executor_windows_sandbox::allow_null_device;
use nova_executor_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use nova_executor_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use nova_executor_windows_sandbox::decode_bytes;
use nova_executor_windows_sandbox::encode_bytes;
use nova_executor_windows_sandbox::get_current_token_for_restriction;
use nova_executor_windows_sandbox::hide_current_user_profile_dir;
use nova_executor_windows_sandbox::log_note;
use nova_executor_windows_sandbox::read_frame;
use nova_executor_windows_sandbox::read_handle_loop;
use nova_executor_windows_sandbox::spawn_process_with_pipes;
use nova_executor_windows_sandbox::to_wide;
use nova_executor_windows_sandbox::token_mode_for_permission_profile;
use nova_executor_windows_sandbox::write_frame;
use std::ffi::OsStr;
use std::fs::File;
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<nova_executor_windows_sandbox::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    ...
    let (pi, job, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = nova_executor_windows_sandbox::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
