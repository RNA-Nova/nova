pub(crate) const OTEL_TARGET_PREFIX: &str = "nova_executor_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "nova_executor_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "nova_executor_otel.trace_safe";
