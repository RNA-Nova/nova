use nova_executor_otel::MetricsClient;
use nova_executor_otel::MetricsConfig;
use nova_executor_otel::OtelExporter;
use nova_executor_otel::OtelHttpProtocol;
use nova_executor_otel::OtelProvider;
use nova_executor_otel::OtelSettings;
use nova_executor_otel::Result;
use nova_executor_otel::current_span_w3c_trace_context;
use nova_executor_otel::set_parent_from_w3c_trace_context;
use nova_executor_protocol_core::protocol::W3cTraceContext;
...
-> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    tracing::subscriber::with_default(subscriber, || {
        ...
        tracing::event!(
            target: "nova_executor_otel.log_only",
            tracing::Level::INFO,
...
-> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let propagated_trace = tracing::subscriber::with_default(subscriber, || {
        ...
        tracing::event!(
            target: "nova_executor_otel.trace_safe",
            tracing::Level::INFO,
