...
use nova_executor_network_proxy::CUSTOM_CA_ENV_KEYS;
...
use nova_executor_network_proxy::is_managed_mitm_ca_trust_bundle_path;
#[cfg(target_os = "windows")]
use nova_executor_network_proxy::strip_managed_proxy_env;
...
use nova_executor_sandboxing::WindowsSandboxFilesystemOverrides;
use nova_executor_sandboxing::WindowsSandboxProxySettingsMode;
use nova_executor_sandboxing::WindowsSandboxSpawnRequest;
use nova_executor_sandboxing::resolve_windows_elevated_filesystem_overrides;
use nova_executor_sandboxing::resolve_windows_restricted_token_filesystem_overrides;
use nova_executor_sandboxing::windows_sandbox_uses_elevated_backend;
use nova_executor_sandboxing::with_managed_mitm_ca_readable_root;
...
struct PreparedWindowsSandboxRequest {
    ...
    windows_sandbox_level: nova_executor_protocol_core::config_types::WindowsSandboxLevel,
    proxy_enforced: bool,
