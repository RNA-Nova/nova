...
use tracing::error;
use ts_rs::TS;
/// W3C 追踪上下文（traceparent/tracestate），随 RPC 请求传播。
...
/// privileges of the agent (e.g. `.nova`, `.git`, notably `.git/hooks`) under
