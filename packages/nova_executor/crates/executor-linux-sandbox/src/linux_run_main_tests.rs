...
fn split_only_filesystem_policy_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        nova_executor_protocol_core::permissions::FileSystemSandboxEntry {
            path: nova_executor_protocol_core::permissions::FileSystemPath::Special {
                value: nova_executor_protocol_core::permissions::FileSystemSpecialPath::project_roots(
                    /*subpath*/ None,
                ),
            },
            access: nova_executor_protocol_core::permissions::FileSystemAccessMode::Write,
            missing_path_behavior: None,
        },
        nova_executor_protocol_core::permissions::FileSystemSandboxEntry {
            path: docs.into(),
            access: nova_executor_protocol_core::permissions::FileSystemAccessMode::Read,
            missing_path_behavior: None,
        },
    ]);
...
fn root_write_read_only_carveout_requires_direct_runtime_enforcement() {
    ...
    let policy = FileSystemSandboxPolicy::restricted(vec![
        nova_executor_protocol_core::permissions::FileSystemSandboxEntry {
            path: nova_executor_protocol_core::permissions::FileSystemPath::Special {
                value: nova_executor_protocol_core::permissions::FileSystemSpecialPath::Root,
            },
            access: nova_executor_protocol_core::permissions::FileSystemAccessMode::Write,
            missing_path_behavior: None,
        },
