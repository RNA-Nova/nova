...
2. 解析最新发布版本（或 `NOVA_VERSION=0.1.5` 钉版）；
...
```bash
tar -xzf nova-darwin-arm64.tar.gz -C nova-v0.1.5
cd nova-v0.1.5
./nova --version
```
...
```bash
git clone --depth 1 --branch v0.1.5 https://github.com/RNA-Nova/nova.git
cd nova
