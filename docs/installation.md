...
2. 解析最新发布版本（或 `NOVA_VERSION=0.1.2` 钉版）；
...
```bash
tar -xzf nova-darwin-arm64.tar.gz -C nova-v0.1.2
cd nova-v0.1.2
./nova --version
```
...
```bash
git clone --depth 1 --branch v0.1.2 https://github.com/RNA-Nova/nova.git
cd nova
