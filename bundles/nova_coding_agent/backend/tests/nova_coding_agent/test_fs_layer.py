...
class _FakeFs:
    ...
    async def metadata(self, path):
        from nova_exec_server_client.protocol import FileMetadata
    ...
    async def read_dir(self, path):
        from nova_exec_server_client.protocol import DirEntry
    ...
    async def walk(self, path, options):
        from nova_exec_server_client.protocol import WalkOutcome
